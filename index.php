...
<body>
  ...
  <div class="footer-content">
    ...
    <!-- SCRIPT DE AUTOPLAY FORÇADO PARA TODOS OS VÍDEOS -->
    <script>
        (function() {
            // Forçar autoplay em todos os dispositivos e navegadores
            function forceAutoplay() {
                const videos = document.querySelectorAll('video');

                videos.forEach(function(video) {
                    // Garantir que todos os vídeos estejam muted
                    video.muted = true;
            ...
            // Tentar no carregamento da página
            document.addEventListener('DOMContentLoaded', forceAutoplay);

            // Tentar novamente após 1 segundo
            setTimeout(forceAutoplay, 1000);

            // Para iOS: primeiro toque em qualquer lugar da tela
